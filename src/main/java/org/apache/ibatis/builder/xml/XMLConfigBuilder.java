...
public class XMLConfigBuilder extends BaseBuilder {
  ...
  private void parseConfiguration(XNode root) {
    try {
      ...
      //s 解析<properties> 节点 设置到 Configuration 的 variables 属性中
      propertiesElement(root.evalNode("properties"));

      //s 解析<settings> 节点 并判断 Configuration 中是否有对应的 setter 方法
      ...
      //s <settings> 节点 设置到 Configuration 中
  ...
  private Properties settingsAsProperties(XNode context) {
    ...
    //s Configuration 中是否有对应的 setter 方法
  ...
  private void propertiesElement(XNode context) throws Exception {
    ...
    if (context != null) {
      ...
      //s properties文件 覆盖 properties元素中的
      if (resource != null) {
  ...
  private void databaseIdProviderElement(XNode context) throws Exception {
    ...
    if (environment != null && databaseIdProvider != null) {
      //s 根据配置的name 找到对应的value 映射文件的SQL上databaseId与当前value一致时，才被加载
